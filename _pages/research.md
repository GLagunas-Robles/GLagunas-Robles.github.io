...
_A) Genotype count in the population between colonies producing gynes and colonies producing males
_B) Proposed inhertiance mechanism
_C) Colony level genotypes between gyne producing and male producing colonies showing the _M~D~_ is associated with gyne-production.
_D) Using colonies spread across the Alaska, British Columbia, and Alberta, we found a similar distribution of genotypes with all the colonies with the _P_ haplotype producing males
